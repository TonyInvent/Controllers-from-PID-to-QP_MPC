...
![Slide 0 — Prologue](assets/servo-motor-controllers-slides/slide-01-welcome-grid.png)
...
![Slide 1 — Title Card](assets/servo-motor-controllers-slides/slide-02-dc-motor-control-evolution.png)
...
![Slide 2 — Act I: PID](assets/servo-motor-controllers-slides/slide-03-pid-history.png)
...
![Slide 3 — Interlude: Poles, Zeros & ODEs](assets/servo-motor-controllers-slides/slide-04-transfer-function-to-ode.png)
...
![Slide 4 — Act II: State-Space & LQR](assets/servo-motor-controllers-slides/slide-05-space-age-lqr.png)
...
![Slide 5 — Act III: MPC & QP-MPC](assets/servo-motor-controllers-slides/slide-06-refinery-qpmc.png)
...
![Slide 6 — Beyond Linearity: Nonlinear MPC](assets/servo-motor-controllers-slides/slide-07-nonlinear-mpc-manifold.png)
...
**Visual:** The same DC motor from Slide 1. Four controller blocks arranged in a row: PID, LQR, QP-MPC, Nonlinear MPC. Below each: *Trial-and-error tuning*, *Optimal unconstrained gains*, *Constrained online optimization*, *Handling true nonlinear dynamics*. The QP-MPC block lights up. Caption: "Each generation's answer to the same question."

![Slide 7 — Epilogue](assets/servo-motor-controllers-slides/slide-08-controller-comparison.png)
...
![Slide 8 — Appendix](assets/servo-motor-controllers-slides/slide-09-simulator-grid.png)
...
|---|---|---|
| `index.html` | Landing page — links to everything | Browser |
