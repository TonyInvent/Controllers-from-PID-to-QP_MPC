...
def extract_title(md_text, fallback):
    """Extract title from first H1 line (# Title), stripping the '# ' prefix."""
...
def main():
    ...
    skip = {'README.md', 'README_cn.md', 'AGENTS.md', 'CLAUDE.md', 'diagram_check.md', 'project_curriculum_plan.md'}
    ...
    for md_path in md_files:
        ...
        # Derive title from first H1 line, fall back to filename stem
