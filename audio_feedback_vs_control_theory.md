...
- **The "disturbances"** are power supply ripple, load impedance vagaries, thermal drift in the bias network, and the obdurate [stubbornly persistent; refuses to be fixed. Like a Class B crossover notch] nonlinearity of the output transistors — that pernicious [harmful in a gradual, subtle way — the kind of distortion you don't notice until you've been listening for an hour and your ears are tired] proclivity of silicon to produce, absent correction, harmonics at percent levels from a nominally sinusoidal input.
...
Audio gestated in telecommunications and consumer electronics. The dominant intellectual tradition was empirical circuit design. The preeminent problems involved noise, distortion, bandwidth, and — this is the ineluctable [inescapable; cannot be avoided. Like the fact that loop gain drops with frequency] differentiator — what things *sounded like* when music passed through them. The culture valorized measurements (THD, SNR, and the invidious tendency to reduce entire systems to a single figure of merit) and, with considerable controversy, subjective listening impressions. There were no proofs. There was no mathematical apparatus of the sort that would earn a control theorist's respect. There was folklore. There was anecdote. There was, and remains, an entire subculture dedicated to the proposition that changing one's power cord alters the spatial characteristics of the stereo image.
...
| **Robustness margins** | Stability under the procrustean [enforcing uniformity by violent means. From Procrustes, the Greek bandit who stretched or amputated victims to fit his bed. Control theory forces all loads into a procrustean uncertainty set — if your loudspeaker doesn't fit, too bad] condition of plant uncertainty | "Will it remain stable when the customer connects a load of entirely unknown provenance?" |
...
### 5.2 The load as protean [ever-changing; able to assume many forms. A loudspeaker load is protean — what it looks like at 100 Hz bears no resemblance to 10 kHz] adversary
...
The amplifier's output impedance — the quantity audio marketers designate with the meretricious [attractive but false; flashy and deceptive. 'Damping factor 1000' is meretricious — sounds impressive, tells you nothing about 10 kHz] term "damping factor" — is the open-loop output impedance divided by the return difference $1+L$. This follows directly, inexorably, from the algebra of feedback.
