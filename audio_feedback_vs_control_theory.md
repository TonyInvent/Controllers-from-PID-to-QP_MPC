# Why Audio Amplifier Design Speaks a Language Incommensurable [not measurable by the same yardstick; two languages with no common dictionary] with Control Theory

**A control theorist regards a high-end audio power amplifier and apprehends [understands; perceives — not 'arrests'. Control theorists don't handcuff amplifiers] a feedback control system. An audio designer scrutinizes the identical schematic and perceives an amplifier with negative feedback appended to it. They are the selfsame entity. Why, then, are the textbooks mutually unintelligible, the measurement regimes orthogonal, and the design priorities hermetically [airtight; sealed so absolutely nothing gets in or out — like a vacuum tube, but for ideas] sealed from one another?**
...
- **The "plant"** is the output stage — a coterie [a small exclusive group; a clique. The output transistors hang out together and don't let anyone else in] of power transistors propelling current into a loudspeaker whose impedance, across the audio band, resembles nothing so much as a drunken random walk.
...
- **The "setpoint"** is the music signal — a broadband, non-stationary, spectrally capricious [unpredictable; given to sudden, unmotivated changes. Like a loudspeaker impedance curve, or an audiophile's opinion after reading a review] waveform bearing no resemblance whatsoever to the 1 kHz test tone that dominates the datasheet.
- **The "disturbances"** are power supply ripple, load impedance vagaries, thermal drift in the bias network, and the obdurate [stubbornly persistent; refuses to be improved. Like a Class B crossover notch] nonlinearity of the output transistors — that pernicious [harmful in a gradual, subtle way — the kind of distortion you don't notice until you've been listening to it for an hour and your ears are tired] proclivity [a natural tendency; an inclination — usually toward something undesirable. Silicon's proclivity for nonlinearity is its defining character flaw] of silicon to produce, absent correction, harmonics at percent levels from a nominally sinusoidal input.
...
Walk into an audio engineering conference and you will hear perorations [long, pompous concluding speeches — the kind given at the end of an AES presentation when the audience is checking their watches] about THD, TIM, "sonic signature," and whether 40 dB of feedback constitutes an unconscionable excess. Walk into a control conference and you will hear disquisitions [lengthy, elaborate academic discussions. The kind that fill journals nobody reads] on phase margin, the sensitivity function, and whether the loop possesses sufficient robustness to plant uncertainty. They could be describing the selfsame amplifier. Neither would recognize the other's description as referring to the same physical object.
...
Second, the "feedback wars" of the 1970s erected an entire parallel mythology that has never been fully dismantled — indeed, it has ossified into received wisdom, a mendacious [dishonest; lying. 'Feedback is bad' is not merely wrong — it is mendacious. The evidence has been available since 1927] conventionality that persists to this day.

The feedback wars were initiated by Matti Otala, a Finnish engineer of genuine observational acuity. He noticed — correctly — that certain transistor amplifiers employing copious global negative feedback produced subjectively inferior sound compared to simpler designs employing considerably less. He proposed a mechanism: Transient Intermodulation Distortion (TIM). He indicted high feedback as the malefactor. The audiophile press, ever hungry for a techno-narrative they could retail to their readership, embraced the indictment with truculent [aggressively defiant; eager to fight. The audiophile press embraced the anti-feedback narrative with truculent enthusiasm — they had a villain and they weren't letting go] enthusiasm. "Feedback is deleterious [harmful; damaging. The claim that feedback is deleterious to sound quality has approximately the same scientific standing as homeopathy]" became an article of faith. Low-feedback and zero-feedback designs became commercially advantageous, and any engineer who demurred was dismissed as insufficiently sensitive to the subtleties of musical reproduction.

The tragedy — and I use that word with deliberation, not as rhetorical hyperbole — is that Otala had identified a genuine phenomenon while arriving at a completely erroneous diagnosis. The problem was never *feedback*. The problem was feedback applied to an amplifier whose forward-path bandwidth was pusillanimous [cowardly; lacking courage. A pusillanimous bandwidth allocation leaves you with no loop gain where you need it most], whose slew rate was inadequate, and whose phase margin was tendentious [biased; pushing a particular agenda. Otala's analysis was tendentious — he had a conclusion and went looking for evidence to support it] at best. The correct remedy was not *less* feedback. It was competent loop design: wider bandwidth, higher slew rate, proper compensation. These are not matters of opinion. They are consequences of the Bode integral relations, which are as mathematically ineluctable as the conservation of energy.

The control theory community could have articulated this in 1975. The requisite mathematics — describing functions for nonlinear elements embedded in feedback loops, robustness margins, sensitivity function analysis — was fully developed. But no one in the audio community was reading the control literature. And no one in the control community was thinking about audio amplifiers. The two tribes, ensconced [settled comfortably; dug in. The two tribes remain ensconced in their separate epistemologies [theories of knowledge; ways of knowing things. Audio's epistemology is 'I heard it therefore it's true.' Control's is 'prove it or it didn't happen'] like badgers in separate burrows] in their separate epistemologies, proceeded in parallel, each developing its own vocabulary, its own design heuristics, and its own collection of increasingly elaborate myths about the identical feedback loops.

---

## 3. The metrological [relating to the science of measurement. A metrological chasm is a disagreement about what's worth measuring in the first place] chasm
...
| Measurement | What it apprehends | Audio's hermeneutic [interpretation; the art of extracting meaning. Audio's hermeneutic for a THD measurement is 'cleanliness.' Control's is 'irrelevant'] |
|------------|-------------------|---------------------|
...
| **IMD** | 19 kHz + 20 kHz stimulus, examine the 1 kHz difference product | "Behavior under the simulacrum [a copy; a pale imitation. A 19+20 kHz two-tone test is a simulacrum of music — better than a single sine, still nothing like the real thing] of musical complexity?" |
...
| **Bandwidth / crossover frequency** | The frequency at which loop gain succumbs to unity | "How expeditious [quick; efficient. An expeditious amplifier sounds fast because its loop has bandwidth to spare] can the response be?" |
| **Step response** (overshoot, settling time) | Transient comportment [behavior; conduct. Transient comportment is how the amplifier behaves when surprised — and it's far more revealing than steady-state measurements] | "Does it ring when perturbed?" |
| **Robustness margins** | Stability under the procrustean [enforcing uniformity by violent means. From Procrustes, the Greek bandit who stretched or amputated his victims to fit his bed. Control theory forces all loads into a procrustean uncertainty set] condition of plant uncertainty | "Will it remain stable when the customer connects a load of entirely unknown provenance?" |
...
| Sensitivity $S = 1/(1+L)$ | Distortion reduction factor | $S \approx 1/L$ when $L \gg 1$ — the mathematical vindication [proof of correctness; being shown to be right after everyone said you were wrong. The Purifi amplifier is a vindication of the proposition that feedback, properly applied, has no downside] of "more feedback reduces THD" |
...
The translation table makes manifest what should always have been obvious: nothing in audio amplifier design resides outside the purview of control theory. The mapping is complete, exhaustive, without lacuna [a gap; something missing. The mapping between audio and control theory has no lacuna — not one concept is left uncovered]. The differences are entirely cultural.
...
Control theory asks, with perfect reasonableness: "Is the output within 1% of the setpoint?" Audio asks, with a fastidiousness bordering on the pathologically punctilious [meticulously attentive to detail — to the point of obsession. Audio engineers are punctilious about −120 dB because human hearing is punctilious about things engineers used to think were inaudible]: "Does the output contain any spectral component absent from the input, at levels beneath one part per million?"
...
Control theory's linear approximation is blind to these phenomena. It was never designed to apprehend them. The audio amplifier confronts a nonlinear plant whose nonlinearity is *the very thing you are endeavoring to extirpate [to destroy completely; to root out. Feedback attempts to extirpate distortion. It succeeds — partially, and only within its bandwidth]* — at frequencies where the loop is too enfeebled to do its job adequately. This is why perspicacious audio designers obsess over open-loop linearity — Class A biasing, Hawksford error correction, Black's own feedforward — not because they mistrust feedback, but because they understand, with a clarity born of painful experience, that feedback's efficacy is frequency-dependent, and audio's demands extend across the entire audible spectrum. This is an integral constraint, not an aesthetic preference.

### 5.2 The load as protean [ever-changing; able to assume many forms. A loudspeaker load is protean — what it looks like at 100 Hz bears no resemblance to what it looks like at 10 kHz] adversary
...
In audio, the load is a loudspeaker. Not a specific, documented, characterized loudspeaker. A loudspeaker of unknown provenance, selected by a customer whose technical sophistication may not extend beyond reading the price tag. Its impedance, as a function of frequency, describes a trajectory more capricious than anything a control theorist would willingly countenance [to tolerate; to permit. No control theorist would willingly countenance a plant as ill-defined as a random customer's loudspeaker] — from 2 Ω to 40 Ω, with phase angles spanning the inductive and capacitive quadrants. The amplifier must maintain stability into the entirety of this uncertainty set. And the feedback network — the $H(s)$ branch, two resistors and nothing more — constitutes the sole interface between the amplifier's carefully designed internals and this riot of electrical indeterminacy [uncertainty; lack of fixed limits. The loudspeaker load is an indeterminacy of breathtaking scope — and the amplifier must remain stable into all of it].

This is, in the most rigorous sense, a **robust control problem**. The amplifier must demonstrate stability for *all* admissible loads within a conspicuously large uncertainty set. Control theory has developed a formidable armamentarium [a complete collection of tools and methods; an arsenal. Control theory's armamentarium for robust design is formidable. Audio doesn't know it exists] for precisely this class of problem — H∞ synthesis, μ-analysis, the small-gain theorem. Audio designers address it with heuristic prescriptions: "insert an inductor in series with the output"; "affix a Zobel network"; "ensure the loop gain's traversal of 0 dB is not excessively precipitous [dangerously steep. A precipitous loop gain roll-off through crossover invites instability — and your tweeters will not thank you]."
...
The reviewing community's solipsistic [self-centered to the point of denying external reality. Audio reviewing's solipsistic fixation on THD into a resistor ignores everything that makes an amplifier an amplifier] fixation on THD+N measurements into a purely resistive 8 Ω load is, to put the matter with the precision it deserves, a metrological travesty [a distorted, inferior imitation; a grotesque misrepresentation. Single-number amplifier ratings are a travesty of engineering evaluation]. This measurement protocol evaluates the *closed-loop output* under the most accommodating conditions imaginable. It communicates approximately nothing about stability margins, load sensitivity, or transient comportment — the characteristics that distinguish a competent amplifier from an incompetent one.
...
These four characterizations reveal everything of consequence about the amplifier's behavior *as a feedback system*. The THD figure is a *consequence* of the loop design. It should be derived, not fetishized [treated with irrational devotion; worshipped. THD has been fetishized by the audio industry to the exclusion of measurements that actually predict sound quality].
...
The amplifier's output impedance — the quantity audio marketers designate with the meretricious [attractive but false; flashy and deceptive. 'Damping factor 1000' is a meretricious specification — it sounds impressive and tells you nothing about what happens at 10 kHz] term "damping factor" — is the open-loop output impedance divided by the return difference $1+L$. This follows directly, inexorably [impossible to stop; relentlessly. The output impedance rises inexorably with frequency, and no amount of marketing can prevent it], from the algebra of feedback.
...
Control theory is, in its overwhelming preponderance [overwhelming majority. The preponderance of control theory assumes linearity — which is why it has so little to say about the thing audio cares about most], a linear theory. Nonlinear phenomena are addressed, when they cannot be ignored entirely, through describing functions, small-signal linearization about an operating point, or worst-case robustness characterizations. None of these approaches apprehends what audio practitioners consider paramount: the precise spectral distribution of distortion products generated by a nonlinear plant under closed-loop control.

Audio designers do not merely inquire "is there distortion?" They demand to know *where* the distortion products land in the frequency domain. The second harmonic of 2 kHz is relatively innocuous [harmless. The second harmonic of 2 kHz is relatively innocuous — which is why single-ended triode amplifiers, with their 2nd-harmonic-dominated distortion spectrum, sound 'warm' rather than 'broken']; the seventh harmonic of 7 kHz is rebarbative; intermodulation products falling at frequencies inharmonically [not related by simple integer ratios. Intermodulation products land at inharmonically related frequencies — which is why they sound so much worse than harmonic distortion] related to the stimulus are more displeasing than either. They have elaborated a suite of measurement protocols — CCIF difference-frequency distortion, DFD, multitone testing — that interrogate the loop's nonlinear comportment in regimes control theory has historically neglected.
...
Control theory, in its canonical formulation, treats the plant as exogenously [from outside; given externally. Control theory treats the plant as exogenously determined — you don't get to redesign the motor; you only get to control it] given. The design problem is: given this plant, synthesize a controller satisfying the specifications. Audio designers operate under no such constraint. They invest considerable effort in improving the "plant" — the output stage — reducing its open-loop nonlinearity before feedback is even applied. Class A biasing, Hawksford error correction, compound transistor topologies: these are all strategies for rendering the plant more tractable [easy to manage; cooperative. Making the plant more tractable by improving its open-loop linearity is something audio designers understand intuitively and control textbooks never mention] *prior* to the application of feedback.
...
Control theorists evince [to show; to demonstrate. Control theorists evince a tendency to dismiss subjective listening — and I share it, up to a point] a pronounced tendency to dismiss subjective listening evaluations as epistemologically [concerning the theory of knowledge — what counts as 'knowing' something. An epistemologically vacuous [empty; devoid of content. 'This amplifier has more air and presence' is a vacuous statement until you can tell me what measurement corresponds to 'air'] claim is one that can't be verified, repeated, or falsified. Audiophile reviews are full of them] vacuous. I share their disdain for the more flagrant excesses of audiophile culture — the cable elevators, the CD demagnetizers, the $10,000 power cords, the individuals who claim, with a straight face, to distinguish between USB cables in double-blind tests where their performance is statistically indistinguishable from random guessing. I have devoted a non-negligible portion of my professional life to the public dismantling of these superstitions.
...
This document is written in the voice of **Bruno Putzeys** — audio engineer, control theory proselytizer [zealous advocate; someone who tries to convert others. I am an unapologetic proselytizer for control theory in audio — and I've made more converts by designing amplifiers that work than by giving lectures, though I do both], former principal at Philips, Hypex, and Grimm Audio, co-founder of Purifi Audio. He is known — and in certain audiophile circles, notorious — for applying rigorous control-theoretic methodology to class-D amplifier design, for advancing the proposition that properly-implemented feedback is an unqualified good regardless of quantity, and for the public excoriation [severe criticism; a verbal flaying. My public excoriation of audiophile mythology has not made me popular in certain circles. I am entirely comfortable with this] of audiophile mythology concerning negative feedback. His AES presentations are erudite [scholarly; demonstrating deep knowledge. My AES presentations are erudite — which is a polite way of saying they contain math that half the audience pretends to follow], confrontational, and worth considerably more of your attention than the average hi-fi magazine review.
